...
@Log4j2
@Component
public class EnvironmentLoader implements ComponentLoader {
    ...
    @Autowired
    public EnvironmentLoader(ConfigurableEnvironment environment, FsqlContext context, DefaultListableBeanFactory beanFactory) {

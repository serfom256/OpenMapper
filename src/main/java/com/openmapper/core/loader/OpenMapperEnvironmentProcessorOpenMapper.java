...
import com.openmapper.util.PackageScanner;
...
public class OpenMapperEnvironmentProcessorOpenMapper implements OpenMapperEnvironmentProcessor {
    ...
    @Autowired
    public OpenMapperEnvironmentProcessorOpenMapper(ConfigurableEnvironment environment, FsqlContext context, DefaultListableBeanFactory beanFactory) {
    ...
    @Override
    public void load() { // todo move to BeanDefinitionRegistryPostProcessor
